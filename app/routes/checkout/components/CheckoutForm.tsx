...
export default function CheckoutForm() {
  return (
    <form className="flex flex-col justify-center mt-20 items-center gap-4 bg-black/70 rounded-3xl max-w-xs md:max-w-lg lg:max-w-4xl mx-auto p-8 md:p-8">
      <h1 className="font-nic text-5xl text-white flex gap-4 items-center">
