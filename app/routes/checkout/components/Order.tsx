      ...
      {cart.length === 0 ? (
        <div className="flex flex-col justify-center items-center gap-4">
          ...
          <img
            ...
            className="w-full aspect-4/1 object-cover shadow-xl shadow-[#FE7F9C]/60 mt-20"
          />
        </div>
      ) : (
        <section>
          <ul>
            <p className="font-thin text-md mx-auto md:text-2xl mt-4 text-center max-w-xs md:max-w-2xl">
              Every order comes with a side of apple pie and ice cream on us.
            </p>
            {cart.map((cheesecake) => (
              <div className="flex flex-col items-center justify-center mt-8 gap-8 font-dm text-lg md:text-2xl">
